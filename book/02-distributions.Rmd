...
```{r}
pitch_by_beat <- left_join(main_seg_in_beat, 
                           pitch_analysis, 
                           by = c("seg_start" = "start"))
```
...
ggplot(pitch_by_beat,
       aes(x = beat_start, y = pitch, color = loudness_start)) +
...
ggplot() +
  geom_linerange(mapping = aes(ymin = start, 
                 ...
                 size = 6) +
  coord_flip() +
  geom_point(mapping = aes(y = beat_start, x = pitch, color = loudness_start),
...
If you haven't watched the [video](https://www.youtube.com/watch?v=vWz9VN40nCA), it's a real 80s experience. I'm going to try to theme the plot after the video.
...
ggplot() +
  geom_linerange(mapping = aes(ymin = start, 
                 ...
                 color = "#60E1FE") +
  coord_flip() +
  geom_point(mapping = aes(y = beat_start, x = pitch, alpha = loudness_start),
             data = pitch_by_beat, 
             color = "#BB1DA8", size = 3,
             show.legend = FALSE) +
