...
ggplot(us_pets, aes(label = Pet, values = Number)) +
  ...
  scale_label_pictogram(
    values = c("dog", "cat", "fish", "crow", "shrimp", "frog", "horse", "fish-fins")
  )
```
...
ggplot(us_pets, aes(label = Pet, values = Number)) +
  geom_pictogram() +
  scale_label_pictogram(
    values = c("dog", "cat", "fish", "crow", "otter", "frog", "horse", "fish")
  )
```
...
Make sure the coordinates are equal to not stretch out the aspect ratio of the icons, add `theme_enhance_waffle()` to get rid of extraneous background, and `theme(axis.ticks = element_blank())` to get rid of the remaining axis ticks. 

Finally, add labels to aid interpretation and for the data provenance.
