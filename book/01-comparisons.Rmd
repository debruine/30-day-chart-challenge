...
font_add(family = "FontAwesome5Free-Brands",
         regular = "/Library/Frameworks/R.framework/Versions/4.1/Resources/library/waffle/fonts/fa-brands-400.ttf")
font_add(family = "FontAwesome5Free-Solid",
         regular = "/Library/Frameworks/R.framework/Versions/4.1/Resources/library/waffle/fonts/fa-solid-900.ttf")
...
However, I had trouble saving the plot using `ggsave()`. The icons end up all question marks. I eventually fixed that by doing something with the fonts, but the icons are still tiny.

```{r, fig.alt="Same as above, but all the icons are tiny."}
